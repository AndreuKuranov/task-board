...
// с сохранением херня получилась, я пере сохраняю все, хотя изменения могут быть не значительными (надо вдумчиво почитать про сетевые запросы)
// и после сохранение происходит перезагрузка страницы, хз почему, еще не разобрался
